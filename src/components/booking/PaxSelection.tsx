            ...
            <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-blue-600 font-medium text-sm sm:text-base">฿{adultPrice.toLocaleString()} per person</p>
                    </div>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-blue-600 font-medium text-sm sm:text-base">฿{childPrice.toLocaleString()} per person</p>
                    </div>
                    {/* Right Column - Controller */}
                    <div className="flex items-center ml-4">
                        <button
